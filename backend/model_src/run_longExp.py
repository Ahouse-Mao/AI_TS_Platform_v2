...
parser.add_argument('--root_path', type=str, default=os.path.join(SCRIPT_DIR, 'dataset'), help='root path of the data file')
...
parser.add_argument('--checkpoints', type=str, default=os.path.join(SCRIPT_DIR, 'checkpoints'), help='location of model checkpoints')
